        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?=SITEURL?>assets/images/" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?=SITEURL?>assets/images/" alt="" height="17">
                        </span>
                    </a>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?=SITEURL?>assets/images/users/wsglobal.jpg" alt="Header Avatar">
                    ...
                    <h6 class="dropdown-header">Merhaba, <?=$userName?></h6>
                        <a class="dropdown-item" href="https://t.me/adonycim"><i class="mdi mdi-lifebuoy text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Destek</span></a>
