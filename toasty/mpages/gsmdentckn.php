            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">GSM->TCKN Sorgu</li>
                    </ol>
                </div>
            </div>
        </div>
   ...
   <div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">GSM->TCKN Sorgu</h4>
                    <p class="mb-1">
                    <p>
                    </p>
                    </p>
                    <div class="block-content tab-content">
                        ...
                        <input class="form-control" type="text" id="tcxx" maxlength="10" placeholder="GSM"><br>
                        </div>
                        <div class="col-xl-12">
                                    <div class="mt-0">
