...
<div class="container-fluid">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-xxl-12">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="firstName" maxlength="11" name="userName"
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="uyelikTipi"
                                                        id="inlineRadio5" value="6">
                                                    <label class="form-check-label" for="inlineRadio5">3 Aylık</label>
                                                    </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="uyelikTipi"
                                                        id="inlineRadio6" value="7">
                                                    <label class="form-check-label" for="inlineRadio6">6 Aylık</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="uyelikTipi"
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="uyelikTipi"
                                                        id="inlineRadio4" value="5">
                                                    <label class="form-check-label" for="inlineRadio4">Sınırsız</label>
                                                </div>
    ...
    <div>
        ...
        if ($allUsers[$i]->userRole == 10) {
            $userAuthKey = "**********";
        }
        
        if ($allUsers[$i]->userRole == 9) {
            $userAuthKey = "**********";
        }
        ...
        ?>
        <input type="text" class="form-control" name="anahtarKey" id="username" value="<?php echo $userAuthKey; ?>" <?php if ($allUsers[$i]->userRole == 10) { echo "readonly"; } ?>>
    </div>
</div>
                                                        <div class="col-xxl-6">
                                                            <div>
                                                            <label for="firstName" class="form-label">Yetki Durumu</label>
<select class="form-select" name="membership" id="validationDefault04" required>
        <?php if ($allUsers[$i]->userRole == 10): ?>
        <option selected value="10">Kurucu</option>
    <?php else: ?>
        <option <?php if ($allUsers[$i]->userRole == 2) { echo "selected"; } ?> value="2">Haftalık</option>
        <option <?php if ($allUsers[$i]->userRole == 3) { echo "selected"; } ?> value="3">Aylık</option>
        <option <?php if ($allUsers[$i]->userRole == 6) { echo "selected"; } ?> value="6">3 Aylık</option>
        <option <?php if ($allUsers[$i]->userRole == 7) { echo "selected"; } ?> value="7">6 Aylık</option>
        <option <?php if ($allUsers[$i]->userRole == 4) { echo "selected"; } ?> value="4">Yıllık</option>
        <option <?php if ($allUsers[$i]->userRole == 5) { echo "selected"; } ?> value="5">Sınırsız</option>
    <?php endif; ?>
</select>
                                                            </div>
                                                        </div><!--end col-->
                                                        ...
                                                        <div class="col-xxl-6">
                                                            <div>
                                                                ...
                                                                <select class="form-select" name="status"
                                                                    ...
                                                                    <option <?php if ($allUsers[$i]->userVerified == 2) {
                                                                        echo "selected";
                                                                    } ?> value="2">Şüpheli</option>
                                                                </select>
                                                            </div>
                                                        </div><!--end col-->
