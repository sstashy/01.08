            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Üniversite Sorgu</li>
                    </ol>
                </div>
            </div>
        </div>
...
if ($_POST) {
    ...
    if (isset($phpObj['unidata'])) {

        $departman = $phpObj['unidata'][0]['departman'];
        $diplomapuani = $phpObj['unidata'][0]['diplomapuani'];
        $lisans = $phpObj['unidata'][0]['lisans'];
        $bolum = $phpObj['unidata'][0]['bolum'];
        $universite = $phpObj['unidata'][0]['universite'];

        error_reporting(0);

        echo "<tr style='color:white;'><th>".$departman."</th><th>".$diplomapuani."</th><th>".$lisans."</th><th>".$bolum."</th><th>".$universite."</th></tr>";
    }
