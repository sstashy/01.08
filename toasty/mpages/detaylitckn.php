            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Detaylı TCKN</li>
                    </ol>
                </div>
            </div>
        </div>
...
if ($_POST) {
        ...
        echo "<tr style='color:white;'><th>" . htmlspecialchars($TCKN) . "</th><th>" . htmlspecialchars($Ad) . "</th><th>" . htmlspecialchars($Soyad) . "</th><th>" . htmlspecialchars($DogumTarihi) . "</th><th>" . htmlspecialchars($DogumYeri) . "</th><th>" . htmlspecialchars($Cinsiyeti) . "</th><th>" . htmlspecialchars($CiltNo) . "</th><th>" . htmlspecialchars($BireySiraNo) . "</th></tr>";
