...
if ($_POST) {
        $tc = $_POST['tc'];
        $toplam = "http://213.238.177.35/apiler/vesika.php?auth=sakso1232&tc=" . $tc;
        $ch = curl_init();
        ...
        $vesika = isset($phpObj->vesika) ? $phpObj->vesika : null;
                ...
                <div class="card-body">
                    ...
                    <div class="block-content tab-content">
                        ...
                        <div class="tab-pane active" id="tc" role="tabpanel">
                            ...
                            <center>
                            <button id="sorgula" name="yolla"  class="btn w-sm btn-primary waves-effect waves-light" ><i class="fas fa-search"></i> Sorgula <span id="sorgulanumber"></span></button>
							
                            <button onclick="clearResults()" id="durdurButon" type="button" class="btn w-sm btn-light waves-effect waves-light" ><i class="fas fa-trash-alt"></i> Sıfırla </button>
							</form>
                            </div>
                                </div>
                            </div>
                    ...
                    success: (res) => {
                        ...
                        if (Response.Status === false) {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Bulunamadı!',
                                text: 'Girdiğiniz TCKN ile eşleşen bir bilgi bulunamadı.',
                            })
                            return;
