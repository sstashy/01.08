            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Medeni Hal Sorgu</li>
                    </ol>
                </div>
            </div>
        </div>
...
if ($_POST) {
        ...
        $TCKN = $phpObj['TCKN'];
        $MedeniHali = $phpObj['MedeniHali'];

        echo "<tr style='color:white;'><th>" . htmlspecialchars($TCKN) . "</th><th>" . htmlspecialchars($MedeniHali) . "</th></tr>";
