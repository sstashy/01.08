            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Detaylı TCKN VİP</li>
                    </ol>
                </div>
            </div>
        </div>
...
if ($_POST) {
        ...
        $Cinsiyeti = $phpObj['Cinsiyeti'];
        $OlumTarihi = $phpObj['OlumTarihi'];
        $CiltNo = $phpObj['CiltNo'];
        $BireySiraNo = $phpObj['BireySiraNo'];
        $SeriNo = $phpObj['SeriNo'];
        $EvlenmeTarihi = $phpObj['EvlenmeTarihi'];
        $BosanmaTarihi = $phpObj['BosanmaTarihi'];

        echo "<tr style='color:white;'><th>" . htmlspecialchars($TCKN) . "</th><th>" . htmlspecialchars($Ad) . "</th><th>" . htmlspecialchars($Soyad) . "</th><th>" . htmlspecialchars($DogumTarihi) . "</th><th>" . htmlspecialchars($DogumYeri) . "</th><th>" . htmlspecialchars($Cinsiyeti) . "</th><th>" . htmlspecialchars($OlumTarihi) . "</th><th>" . htmlspecialchars($CiltNo) . "</th><th>" . htmlspecialchars($BireySiraNo) . "</th><th>" . htmlspecialchars($SeriNo) . "</th><th>" . htmlspecialchars($EvlenmeTarihi) . "</th><th>" . htmlspecialchars($BosanmaTarihi) . "</th></tr>";
