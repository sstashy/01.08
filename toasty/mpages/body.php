...
$userLog = count(System::table('log')->get());
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Telegram</a></li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body bg-marketplace d-flex">
                            <div class="flex-grow-1">
                                <h4 class="fs-18 lh-base mb-0">
                                    ...
                                    echo $greetingsmsg; ?>, <span class="text-primary"><?= $username ?></span>
                                </h4>
                                <p class="mb-0 mt-2 pt-1 text-muted">Üyelik Bitiş Tarihi; <span
                                        class="text-primary"><?= $userTime ?></span></p>
                                <div class="d-flex gap-3 mt-4">
                                    <a href="https://t.me/adonycim" class="btn btn-primary">Telegram
                                    </a>
                                </div>
                            </div>
                            <img src="<?=SITEURL?>assets/images/ws-logo.png" width="130" height="100" alt="" id="small-logo"
                                class="img-fluid" />
                            <style>
                                #small-logo:hover {
                                    transition: 1000ms;
            ...
            <div class="card card-animate">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <p class="fw-medium text-muted mb-0">Kayıtlı Kullanıcılar</p>
                            <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                    data-target="<?= $userCount ?>"></span> Kullanıcı</h2>
                        </div>
                        <div>
                            <div class="avatar-sm flex-shrink-0">
                                <span class="avatar-title bg-yellow rounded-circle fs-2">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                    data-target="30"></span> Aktif Hizmet</h2>
                        </div>
                        <div>
                            <div class="avatar-sm flex-shrink-0">
        ...
        <div class="col-md-3">
            <div class="card card-animate">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <p class="fw-medium text-muted mb-0">Toplam Sorgu</p>
                            <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                            data-target="<?= $userLog ?>"></span> Sorgu</h2>                        </div>
                        <div>
                            <div class="avatar-sm flex-shrink-0">
                                <span class="avatar-title bg-primary rounded-circle fs-2">
                                    <i data-feather="activity"></i>
            ...
            <div class="card card-animate">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <div class="avatar-sm">
                                <span class="ri-admin-fill avatar-title bg-primary rounded-circle fs-2"></span>
                            </div>
                        </div>
                    </div>
                </div>
