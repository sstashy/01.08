            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Evlilik & Boşanma</li>
                    </ol>
                </div>
            </div>
        </div>
...
if ($_POST) {
        ...
        echo "<tr style='color:white;'><th>" . htmlspecialchars($EvlenmeTarihi) . "</th><th>" . htmlspecialchars($BosanmaTarihi) . "</th></tr>";
