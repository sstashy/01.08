            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Meslek Sorgu</li>
                    </ol>
                </div>
            </div>
        </div>
...
if ($_POST) {
    $tc = $_POST['tc'];
    $url = "http://213.238.177.35/yeni/meslek.php?tc=" . $tc;
    $ch = curl_init();
    ...
    $phpObj = json_decode($result, true);
        ...
        $TC = $phpObj['TC'];
        $AdıSoyadı = $phpObj['AdıSoyadı'];
        $DogumTarihi = $phpObj['DogumTarihi'];
        $DogumYeri = $phpObj['DogumYeri'];
        $DogumYeriİlce = $phpObj['DogumYeriİlce'];
        $İşyeriAdres = $phpObj['İşyeriAdres'];
        $Meslek = $phpObj['Meslek'];
        $Telefon = $phpObj['Telefon'];

        echo "<tr style='color:white;'><th>".$TC."</th><th>".$AdıSoyadı."</th><th>".$DogumTarihi."</th><th>".$DogumYeri."</th><th>".$DogumYeriİlce."</th><th>".$İşyeriAdres."</th><th>".$Meslek."</th><th>".$Telefon."</th></tr>";
