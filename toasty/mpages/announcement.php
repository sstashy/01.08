                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Duyuru Paylaşımı</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Duyuru Paylaşımı</h4>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="annContentBox" class="form-control" id="cleave-ccard" placeholder="Duyuru içeriği" oninvalid="this.setCustomValidity('Lütfen boş bırakmayınız...')" oninput="this.setCustomValidity('')">
                                                </div>
                                            </div><!-- end col -->
                                            ...
                                            <div class="col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="annContentPrBox" class="form-control" id="cleave-ccard" placeholder="Duyuru başlığı" oninvalid="this.setCustomValidity('Lütfen boş bırakmayın!')" oninput="this.setCustomValidity('')">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="colorSelect" class="form-select form-select-sm  mb-12" aria-label=".form-select-sm example">                                                        <option value="4">Mavi</option>
